...
<div class="row">
	<div class="col-md-8">
		...
		<p>Find a (free) gate by specifying the callsign and aircraft type. You can use this system for manually looking up and assigning callsigns.
			However, for your convenience, it might be better to use the <a href="index.php">VATSIM Inbound List</a>.</p>
